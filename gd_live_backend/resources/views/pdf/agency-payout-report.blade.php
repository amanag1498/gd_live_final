...
<body>
  ...
  <table class="summary">
    ...
    <tr>
      ...
      <td><div class="label">Video Room Gifts</div><div class="value">{{ number_format($report->total_video_gift_coins) }}</div></td>
    ...
    <tr>
      ...
      <td><div class="label">Published By</div><div class="value">{{ $report->publishedByAdmin?->name ?? '—' }}</div></td>
    </tr>
  </table>
