<header
    ...
    <div class="flex flex-col items-center justify-between grow xl:flex-row xl:px-6">
        <div
            ...
            <!-- Logo (mobile only) -->
            <a href="{{ $homeRoute ?? url('/') }}" class="xl:hidden">
                <x-layout.brand-mark compact />
            </a>
            ...
            <div class="hidden xl:block">
                <div>
                    <div class="text-xs font-medium uppercase tracking-[0.18em] text-gray-400">{{ $panelLabel ?? 'Panel' }}</div>
                    <h1 class="text-2xl font-semibold text-gray-900 dark:text-white">@yield('title', $defaultTitle ?? 'GD Live')</h1>
                </div>
            </div>
        </div>
