...
<div class="relative" x-data="{
    ...
    >
       ...
       <span class="block mr-1 font-medium text-theme-sm"><?php echo e($user?->name ?? 'User'); ?></span>
    ...
    >
        <!-- User Info -->
        <div>
            <span class="block font-medium text-gray-700 text-theme-sm dark:text-gray-400"><?php echo e($user?->name ?? 'User'); ?></span>
            <span class="mt-0.5 block text-theme-xs text-gray-500 dark:text-gray-400"><?php echo e($user?->email ?? '—'); ?></span>
        </div>
...
<?php /**PATH /Users/amanagarwal/Desktop/gd_remake/gd_live_backend/resources/views/components/header/user-dropdown.blade.php ENDPATH**/ ?>