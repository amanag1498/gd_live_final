<header
    ...
    <div class="flex flex-col items-center justify-between grow xl:flex-row xl:px-6">
        <div
            ...
            <!-- Logo (mobile only) -->
            <a href="<?php echo e($homeRoute ?? url('/')); ?>" class="xl:hidden">
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.layout.brand-mark','data' => ['compact' => true]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
            ...
            <div class="hidden xl:block">
                <div>
                    <div class="text-xs font-medium uppercase tracking-[0.18em] text-gray-400"><?php echo e($panelLabel ?? 'Panel'); ?></div>
                    <h1 class="text-2xl font-semibold text-gray-900 dark:text-white"><?php echo $__env->yieldContent('title', $defaultTitle ?? 'GD Live'); ?></h1>
                </div>
            </div>
        </div>
...
<?php /**PATH /Users/amanagarwal/Desktop/gd_remake/gd_live_backend/resources/views/layouts/app-header.blade.php ENDPATH**/ ?>