...
<form method="post" action="<?php echo e(route('admin.banners.update', $banner)); ?>" enctype="multipart/form-data" class="space-y-6">
  <?php echo csrf_field(); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['color' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($banner->is_active ? 'success' : 'dark')]); ?><?php echo e($banner->is_active ? 'Active' : 'Inactive'); ?> <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginalab7baa01105b3dfe1e0cf1dfc58879b4)): ?>
<?php $attributes = $__attributesOriginalab7baa01105b3dfe1e0cf1dfc58879b4; ?>
<?php unset($__attributesOriginalab7baa01105b3dfe1e0cf1dfc58879b4); ?>
...
<?php endif; ?>
          ...
          <h2 class="text-2xl font-semibold tracking-tight text-gray-900 dark:text-white"><?php echo e($banner->title); ?></h2>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.admin.stat-card','data' => ['label' => 'Placement','value' => ucfirst($banner->placement),'meta' => 'Current banner surface']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['label' => 'Placement','value' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(ucfirst($banner->placement)),'meta' => 'Current banner surface']); ?>
...
<?php endif; ?>
          <?php if (isset($component)) { $__componentOriginal3c3cb599308b2d9971dae437d0b6bab6 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal3c3cb599308b2d9971dae437d0b6bab6 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.admin.stat-card','data' => ['label' => 'Action Type','value' => strtoupper($banner->action_type),'meta' => 'Current CTA behaviour','tone' => 'dark']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('admin.stat-card'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['label' => 'Action Type','value' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(strtoupper($banner->action_type)),'meta' => 'Current CTA behaviour','tone' => 'dark']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginal3c3cb599308b2d9971dae437d0b6bab6)): ?>
<?php $attributes = $__attributesOriginal3c3cb599308b2d9971dae437d0b6bab6; ?>
...
<?php endif; ?>
      ...
      <div class="grid gap-4 lg:grid-cols-12">
        <div class="lg:col-span-6">
          ...
          <input name="title" class="<?php echo e($inputClass); ?>" value="<?php echo e(old('title', $banner->title)); ?>" required maxlength="120">
        </div>
        <div class="lg:col-span-6">
        ...
        <div class="lg:col-span-6">
          ...
          <input name="image_url" class="<?php echo e($inputClass); ?>" value="<?php echo e(old('image_url', $banner->image_url)); ?>" maxlength="2048">
        </div>
        <div class="lg:col-span-6">
          <label class="mb-2 block text-sm font-medium text-gray-700 dark:text-gray-300">Target URL</label>
          <input name="target_url" class="<?php echo e($inputClass); ?>" value="<?php echo e(old('target_url', $banner->target_url)); ?>">
        </div>
        <div class="lg:col-span-4">
          ...
          <select name="placement" class="<?php echo e($inputClass); ?>" required>
            <?php $__currentLoopData = $placements; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $placement): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
              <option value="<?php echo e($placement); ?>" <?php if(old('placement', $banner->placement) === $placement): echo 'selected'; endif; ?>><?php echo e(ucfirst($placement)); ?></option>
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
          </select>
        </div>
        <div class="lg:col-span-4">
          ...
          <select name="action_type" class="<?php echo e($inputClass); ?>" required>
            <?php $__currentLoopData = $actionTypes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $actionType): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
              <option value="<?php echo e($actionType); ?>" <?php if(old('action_type', $banner->action_type) === $actionType): echo 'selected'; endif; ?>><?php echo e(strtoupper($actionType)); ?></option>
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
          </select>
        </div>
        <div class="lg:col-span-4">
          <label class="mb-2 block text-sm font-medium text-gray-700 dark:text-gray-300">Button Text</label>
          <input name="button_text" class="<?php echo e($inputClass); ?>" value="<?php echo e(old('button_text', $banner->button_text)); ?>" maxlength="60" placeholder="Open">
        </div>
        <div class="lg:col-span-8">
          <label class="mb-2 block text-sm font-medium text-gray-700 dark:text-gray-300">Action Value</label>
          <input name="action_value" class="<?php echo e($inputClass); ?>" value="<?php echo e(old('action_value', $banner->action_value)); ?>" placeholder="URL, deep link, or route">
        </div>
        <div class="lg:col-span-4">
          <label class="mb-2 block text-sm font-medium text-gray-700 dark:text-gray-300">Sort Order</label>
          <input type="number" min="0" name="sort_order" class="<?php echo e($inputClass); ?>" value="<?php echo e(old('sort_order', $banner->sort_order)); ?>">
        </div>
        <div class="lg:col-span-6">
          <label class="mb-2 block text-sm font-medium text-gray-700 dark:text-gray-300">Starts At</label>
          <input type="datetime-local" name="starts_at" class="<?php echo e($inputClass); ?>" value="<?php echo e(old('starts_at', $banner->starts_at?->format('Y-m-d\\TH:i'))); ?>">
        </div>
        <div class="lg:col-span-6">
          <label class="mb-2 block text-sm font-medium text-gray-700 dark:text-gray-300">Ends At</label>
          <input type="datetime-local" name="ends_at" class="<?php echo e($inputClass); ?>" value="<?php echo e(old('ends_at', $banner->ends_at?->format('Y-m-d\\TH:i'))); ?>">
        </div>
          ...
          <div class="grid gap-2 sm:grid-cols-3">
            <?php $__currentLoopData = $platforms; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $platform): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
              <label class="flex items-center gap-3 rounded-xl border border-gray-200 bg-gray-50 px-4 py-3 text-sm text-gray-700 dark:border-gray-800 dark:bg-gray-950/60 dark:text-gray-300">
                <input class="h-4 w-4 rounded border-gray-300 text-brand-500 focus:ring-brand-500/30 dark:border-gray-700 dark:bg-gray-900" type="checkbox" name="platforms[]" value="<?php echo e($platform); ?>" <?php if(in_array($platform, $selectedPlatforms, true)): echo 'checked'; endif; ?>>
        ...
        <div class="lg:col-span-6">
          ...
          <div class="grid gap-2 sm:grid-cols-3">
            <?php $__currentLoopData = $roles; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $role): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
              <label class="flex items-center gap-3 rounded-xl border border-gray-200 bg-gray-50 px-4 py-3 text-sm text-gray-700 dark:border-gray-800 dark:bg-gray-950/60 dark:text-gray-300">
                <input class="h-4 w-4 rounded border-gray-300 text-brand-500 focus:ring-brand-500/30 dark:border-gray-700 dark:bg-gray-900" type="checkbox" name="target_roles[]" value="<?php echo e($role); ?>" <?php if(in_array($role, $selectedRoles, true)): echo 'checked'; endif; ?>>
        ...
        <div class="lg:col-span-12">
          ...
          <label class="flex items-center gap-3 rounded-xl border border-gray-200 bg-gray-50 px-4 py-3 text-sm text-gray-700 dark:border-gray-800 dark:bg-gray-950/60 dark:text-gray-300">
            ...
            <input class="h-5 w-5 rounded border-gray-300 text-brand-500 focus:ring-brand-500/30 dark:border-gray-700 dark:bg-gray-900" type="checkbox" name="is_active" value="1" <?php echo e(old('is_active', (int) $banner->is_active) ? 'checked' : ''); ?>>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['type' => 'submit','size' => 'sm']); ?>Update Banner <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginala8bb031a483a05f647cb99ed3a469847)): ?>
<?php $attributes = $__attributesOriginala8bb031a483a05f647cb99ed3a469847; ?>
<?php unset($__attributesOriginala8bb031a483a05f647cb99ed3a469847); ?>
...
<?php endif; ?>
    ...
    <?php if (isset($component)) { $__componentOriginalb8dfe58016103e374219da4cf072c7cf = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginalb8dfe58016103e374219da4cf072c7cf = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.common.component-card','data' => ['title' => 'Preview','desc' => 'Current creative preview for this banner.']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('common.component-card'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['title' => 'Preview','desc' => 'Current creative preview for this banner.']); ?>
      <div class="flex min-h-[220px] items-center justify-center rounded-2xl border border-dashed border-gray-300 bg-gray-50 p-4 dark:border-gray-700 dark:bg-gray-950/60">
        <?php if($previewUrl !== ''): ?>
          <img src="<?php echo e($previewUrl); ?>" alt="banner" class="max-h-[180px] w-full rounded-2xl object-contain" onerror="this.style.display='none'; this.nextElementSibling.style.display='block';">
...
<?php echo $__env->make('layouts.admin-tailadmin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/amanagarwal/Desktop/gd_remake/gd_live_backend/resources/views/admin/banners/edit.blade.php ENDPATH**/ ?>