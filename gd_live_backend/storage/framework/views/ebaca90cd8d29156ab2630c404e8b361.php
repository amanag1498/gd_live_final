<?php $__env->startSection('title','Edit Agency #'.$agency->id); ?>
...
<form method="post" action="<?php echo e(route('admin.agencies.update',$agency)); ?>" class="space-y-6">
  <?php echo csrf_field(); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['color' => 'dark']); ?>Agency <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['color' => 'brand']); ?>Profile <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginalab7baa01105b3dfe1e0cf1dfc58879b4)): ?>
<?php $attributes = $__attributesOriginalab7baa01105b3dfe1e0cf1dfc58879b4; ?>
<?php unset($__attributesOriginalab7baa01105b3dfe1e0cf1dfc58879b4); ?>
...
<?php endif; ?>
          ...
          <h2 class="text-2xl font-semibold tracking-tight text-gray-900 dark:text-white"><?php echo e($agency->name); ?></h2>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.ui.button','data' => ['variant' => 'outline','size' => 'sm','href' => ''.e(route('admin.agencies.index')).'']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['variant' => 'outline','size' => 'sm','href' => ''.e(route('admin.agencies.index')).'']); ?>Back <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php endif; ?>
    ...
    <div class="grid gap-4 lg:grid-cols-12">
      <div class="lg:col-span-6">
        ...
        <input class="<?php echo e($inputClass); ?>" name="name" value="<?php echo e(old('name',$agency->name)); ?>">
      </div>
      <div class="lg:col-span-6">
        <label class="mb-2 block text-sm font-medium text-gray-700 dark:text-gray-300">Contact Email</label>
        <input type="email" class="<?php echo e($inputClass); ?>" name="contact_email" value="<?php echo e(old('contact_email',$agency->contact_email)); ?>">
      </div>
      <div class="lg:col-span-6">
        <label class="mb-2 block text-sm font-medium text-gray-700 dark:text-gray-300">Contact Phone</label>
        <input class="<?php echo e($inputClass); ?>" name="contact_phone" value="<?php echo e(old('contact_phone',$agency->contact_phone)); ?>">
      </div>
      <div class="lg:col-span-12">
        <label class="mb-2 block text-sm font-medium text-gray-700 dark:text-gray-300">Notes</label>
        <textarea class="<?php echo e($textareaClass); ?>" name="notes" rows="4"><?php echo e(old('notes',$agency->notes)); ?></textarea>
      </div>
    </div>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['variant' => 'outline','size' => 'sm','href' => ''.e(route('admin.agencies.index')).'']); ?>Cancel <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginala8bb031a483a05f647cb99ed3a469847)): ?>
<?php $attributes = $__attributesOriginala8bb031a483a05f647cb99ed3a469847; ?>
<?php unset($__attributesOriginala8bb031a483a05f647cb99ed3a469847); ?>
...
<?php echo $__env->make('layouts.admin-tailadmin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/amanagarwal/Desktop/gd_remake/gd_live_backend/resources/views/admin/agencies/edit.blade.php ENDPATH**/ ?>