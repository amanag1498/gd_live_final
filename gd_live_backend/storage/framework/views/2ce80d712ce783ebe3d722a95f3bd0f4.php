...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['color' => 'brand']); ?>App Controls <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginalab7baa01105b3dfe1e0cf1dfc58879b4)): ?>
<?php $attributes = $__attributesOriginalab7baa01105b3dfe1e0cf1dfc58879b4; ?>
<?php unset($__attributesOriginalab7baa01105b3dfe1e0cf1dfc58879b4); ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.admin.stat-card','data' => ['label' => 'Bootstrap Endpoint','value' => '/api/app-config','meta' => 'Public app config source']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['label' => 'Bootstrap Endpoint','value' => '/api/app-config','meta' => 'Public app config source']); ?>
...
<?php endif; ?>
          <?php if (isset($component)) { $__componentOriginal3c3cb599308b2d9971dae437d0b6bab6 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal3c3cb599308b2d9971dae437d0b6bab6 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.admin.stat-card','data' => ['label' => 'Maintenance Bypass','value' => 'Admin and health routes','meta' => 'Safe paths during maintenance','tone' => 'dark']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('admin.stat-card'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['label' => 'Maintenance Bypass','value' => 'Admin and health routes','meta' => 'Safe paths during maintenance','tone' => 'dark']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginal3c3cb599308b2d9971dae437d0b6bab6)): ?>
<?php $attributes = $__attributesOriginal3c3cb599308b2d9971dae437d0b6bab6; ?>
...
<?php endif; ?>
  ...
  <form method="post" action="<?php echo e(route('admin.settings.app.update')); ?>" class="space-y-6">
    <?php echo csrf_field(); ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.common.component-card','data' => ['title' => $groupLabel,'desc' => 'Stored in app_settings and loaded into runtime config.']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['title' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($groupLabel),'desc' => 'Stored in app_settings and loaded into runtime config.']); ?>
        <div class="grid gap-4 xl:grid-cols-2">
          <?php $__currentLoopData = $definitions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $definition): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <?php if(($definition['group'] ?? 'general') !== $groupKey) continue; ?>
              ...
              <?php if(($definition['type'] ?? 'boolean') === 'string' && !empty($definition['options'])): ?>
                <select class="<?php echo e($inputClass); ?>" name="<?php echo e($inputName); ?>">
                  <?php $__currentLoopData = ($definition['options'] ?? []); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $option): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <option value="<?php echo e($option); ?>" <?php if(old($key, $values[$key] ?? $definition['default'] ?? null) === $option): echo 'selected'; endif; ?>><?php echo e(ucfirst($option)); ?></option>
                  <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                </select>
              <?php elseif(($definition['type'] ?? 'boolean') === 'csv_integer_list' || ($definition['type'] ?? 'boolean') === 'string'): ?>
                <input type="text" class="<?php echo e($inputClass); ?>" name="<?php echo e($inputName); ?>" value="<?php echo e(old($key, $values[$key] ?? $definition['default'] ?? '')); ?>">
              <?php elseif(($definition['type'] ?? 'boolean') === 'integer'): ?>
                <input
                  type="number"
                  class="<?php echo e($inputClass); ?>"
                  name="<?php echo e($inputName); ?>"
                  value="<?php echo e(old($key, $values[$key] ?? $definition['default'] ?? '')); ?>"
                  <?php if(array_key_exists('min', $definition)): ?> min="<?php echo e($definition['min']); ?>" <?php endif; ?>
                  <?php if(array_key_exists('max', $definition)): ?> max="<?php echo e($definition['max']); ?>" <?php endif; ?>
                  step="1"
                >
              <?php else: ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['type' => 'submit','size' => 'sm']); ?>Save App Settings <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php echo $__env->make('layouts.admin-tailadmin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/amanagarwal/Desktop/gd_remake/gd_live_backend/resources/views/admin/settings/app.blade.php ENDPATH**/ ?>