...
<?php $component->withAttributes([]); ?>
   <?php $__env->slot('header', null, []); ?> 
    <div class="flex items-center justify-between gap-3">
      <div>
        <h3 class="text-base font-semibold text-gray-900 dark:text-white"><?php echo e($mode === 'create' ? 'Create Recharge Plan' : 'Edit Recharge Plan'); ?></h3>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.ui.button','data' => ['variant' => 'outline','size' => 'sm','href' => ''.e(route('admin.recharge-plans.index')).'']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['variant' => 'outline','size' => 'sm','href' => ''.e(route('admin.recharge-plans.index')).'']); ?>Back <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php endif; ?>
  ...
  <div class="grid gap-4 lg:grid-cols-12">
    <div class="lg:col-span-5">
      ...
      <input type="text" name="title" class="<?php echo e($inputClass); ?>" value="<?php echo e(old('title', $plan->title)); ?>" required>
...
unset($__errorArgs, $__bag); ?>
    ...
    <div class="lg:col-span-3">
      ...
      <input type="number" step="0.01" min="1" name="amount_rupees" class="<?php echo e($inputClass); ?>" value="<?php echo e(old('amount_rupees', $plan->amount_rupees)); ?>" required>
      <?php $__errorArgs = ['amount_rupees'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?><div class="mt-2 text-sm text-error-600 dark:text-error-300"><?php echo e($message); ?></div><?php unset($message);
...
unset($__errorArgs, $__bag); ?>
    ...
    <div class="lg:col-span-2">
      ...
      <input type="number" min="0" name="sort_order" class="<?php echo e($inputClass); ?>" value="<?php echo e(old('sort_order', $plan->sort_order)); ?>" required>
...
unset($__errorArgs, $__bag); ?>
    ...
    <div class="lg:col-span-2">
      ...
      <label class="flex h-11 items-center gap-3 rounded-xl border border-gray-200 bg-gray-50 px-4 dark:border-gray-800 dark:bg-gray-950/60">
        ...
        <input class="h-5 w-5 rounded border-gray-300 text-brand-500 focus:ring-brand-500/30 dark:border-gray-700 dark:bg-gray-900" type="checkbox" name="is_active" value="1" <?php if((bool) old('is_active', $plan->is_active)): echo 'checked'; endif; ?>>
    ...
    <div class="lg:col-span-4">
      ...
      <input type="number" min="1" name="coins" class="<?php echo e($inputClass); ?>" value="<?php echo e(old('coins', $plan->coins)); ?>" required>
...
unset($__errorArgs, $__bag); ?>
    ...
    <div class="lg:col-span-4">
      ...
      <input type="number" min="0" name="bonus_coins" class="<?php echo e($inputClass); ?>" value="<?php echo e(old('bonus_coins', $plan->bonus_coins)); ?>">
      <?php $__errorArgs = ['bonus_coins'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?><div class="mt-2 text-sm text-error-600 dark:text-error-300"><?php echo e($message); ?></div><?php unset($message);
...
unset($__errorArgs, $__bag); ?>
    ...
    <div class="lg:col-span-4">
      ...
      <input type="text" class="<?php echo e($inputClass); ?>" value="<?php echo e(number_format((int) ($plan->total_coins ?? (($plan->coins ?? 0) + ($plan->bonus_coins ?? 0))))); ?>" disabled>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['variant' => 'outline','size' => 'sm','href' => ''.e(route('admin.recharge-plans.index')).'']); ?>Cancel <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginala8bb031a483a05f647cb99ed3a469847)): ?>
<?php $attributes = $__attributesOriginala8bb031a483a05f647cb99ed3a469847; ?>
<?php unset($__attributesOriginala8bb031a483a05f647cb99ed3a469847); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['type' => 'submit','size' => 'sm']); ?><?php echo e($mode === 'create' ? 'Create Plan' : 'Save Changes'); ?> <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginala8bb031a483a05f647cb99ed3a469847)): ?>
<?php $attributes = $__attributesOriginala8bb031a483a05f647cb99ed3a469847; ?>
<?php unset($__attributesOriginala8bb031a483a05f647cb99ed3a469847); ?>
...
<?php endif; ?>
<?php /**PATH /Users/amanagarwal/Desktop/gd_remake/gd_live_backend/resources/views/admin/recharge-plans/_form.blade.php ENDPATH**/ ?>