<?php $__env->startSection('title','Moderation Rules'); ?>
    ...
    <div class="col-md-6 col-xl-3">
      <div class="moderation-stat-card h-100">
        <div class="card-body">
          ...
          <div class="display-6 fw-semibold"><?php echo e($activeCount); ?></div>
    ...
    <div class="col-md-6 col-xl-3">
      <div class="moderation-stat-card h-100">
        <div class="card-body">
          ...
          <div class="display-6 fw-semibold"><?php echo e($reviewCount); ?></div>
    ...
    <div class="col-md-6 col-xl-3">
      <div class="moderation-stat-card h-100">
        <div class="card-body">
          ...
          <div class="display-6 fw-semibold"><?php echo e($kickOrBlockCount); ?></div>
    ...
    <div class="col-md-6 col-xl-3">
      <div class="moderation-stat-card h-100">
        <div class="card-body">
          ...
          <div class="display-6 fw-semibold"><?php echo e($criticalCount); ?></div>
    ...
    <div class="col-xl-4">
      <div class="card moderation-create-card mb-3">
        ...
        <div class="card-body pt-3">
          <form method="post" action="<?php echo e(route('admin.moderation.rules.store')); ?>" class="row g-3">
            <?php echo csrf_field(); ?>
            <div class="col-12">
            ...
            <div class="col-12">
              ...
              <select class="form-select" name="rule_type">
                <?php $__currentLoopData = $ruleTypes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            ...
            <div class="col-md-6">
              ...
              <select class="form-select" name="severity">
                <?php $__currentLoopData = $severities; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
      ...
      <div class="card moderation-table-card">
        <div class="card-header border-0 pb-0">
          <div class="d-flex flex-wrap align-items-start justify-content-between gap-3">
            ...
            <div class="d-flex flex-wrap gap-2">
              <?php $__currentLoopData = $ruleTypes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <span class="rule-chip bg-light text-dark border"><?php echo e($item); ?></span>
              <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            </div>
          </div>
        </div>
        <div class="card-body pt-3">
          <div class="row g-2 mb-3">
            <?php $__currentLoopData = $typeHelp; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $type => $help): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
              <div class="col-md-6">
                <div class="border rounded-4 p-3 h-100 bg-light-subtle">
                  <div class="fw-semibold mb-1"><?php echo e($type); ?></div>
                  <div class="text-muted small"><?php echo e($help); ?></div>
                </div>
              </div>
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
          </div>
          ...
          <?php $__empty_1 = true; $__currentLoopData = $rules; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $rule): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
            <div class="rule-row p-3">
              <div class="d-flex flex-wrap align-items-start justify-content-between gap-3 mb-3">
                <div>
                  <div class="d-flex flex-wrap align-items-center gap-2 mb-2">
                    <span class="rule-chip <?php echo e($actionBadge($rule->action)); ?>"><?php echo e(strtoupper($rule->action)); ?></span>
                    <span class="rule-chip <?php echo e($severityBadge($rule->severity)); ?>"><?php echo e(strtoupper($rule->severity)); ?></span>
                    <span class="rule-chip <?php echo e($rule->is_active ? 'bg-success-subtle text-success border border-success-subtle' : 'bg-secondary-subtle text-secondary border border-secondary-subtle'); ?>">
                      <?php echo e($rule->is_active ? 'ACTIVE' : 'INACTIVE'); ?>

                    </span>
                  </div>
                  <div class="fw-semibold fs-6"><?php echo e($rule->rule_key); ?></div>
                  <div class="text-muted small">
                    <?php echo e($typeHelp[$rule->rule_type] ?? 'Rule behavior depends on its type and action.'); ?>

                  </div>
                </div>
                <form method="post" action="<?php echo e(route('admin.moderation.rules.destroy', $rule)); ?>" onsubmit="return confirm('Delete this rule?')">
                  <?php echo csrf_field(); ?>
              ...
              <form id="rule-<?php echo e($rule->id); ?>" method="post" action="<?php echo e(route('admin.moderation.rules.update', $rule)); ?>">
                <?php echo csrf_field(); ?>
                ...
                <div class="rule-grid">
                  <div>
                    <label class="rule-mini-label">Rule Key</label>
                    <input class="form-control form-control-sm" name="rule_key" value="<?php echo e($rule->rule_key); ?>" required>
                  </div>
                  <div>
                    <label class="rule-mini-label">Type</label>
                    <select class="form-select form-select-sm" name="rule_type">
                      <?php $__currentLoopData = $ruleTypes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <option value="<?php echo e($item); ?>" <?php if($rule->rule_type === $item): echo 'selected'; endif; ?>><?php echo e($item); ?></option>
                      <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </select>
                  </div>
                  <div>
                    <label class="rule-mini-label">Pattern</label>
                    <input class="form-control form-control-sm" name="pattern" value="<?php echo e($rule->pattern); ?>" placeholder="literal phrase or keyword">
                  </div>
                  <div>
                    <label class="rule-mini-label">Threshold</label>
                    <input class="form-control form-control-sm" type="number" min="1" name="threshold" value="<?php echo e($rule->threshold); ?>" placeholder="3">
                  </div>
                  <div>
                    <label class="rule-mini-label">Window (Minutes)</label>
                    <input class="form-control form-control-sm" type="number" min="1" name="duration_minutes" value="<?php echo e($rule->duration_minutes); ?>" placeholder="1">
                  </div>
                  <div>
                    <label class="rule-mini-label">Action</label>
                    <select class="form-select form-select-sm" name="action">
                      <?php $__currentLoopData = $actions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <option value="<?php echo e($item); ?>" <?php if($rule->action === $item): echo 'selected'; endif; ?>><?php echo e($item); ?></option>
                      <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </select>
                  </div>
                </div>
                ...
                <div class="row g-3 mt-1 align-items-end">
                  <div class="col-md-4">
                    ...
                    <select class="form-select form-select-sm" name="severity">
                      <?php $__currentLoopData = $severities; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <option value="<?php echo e($item); ?>" <?php if($rule->severity === $item): echo 'selected'; endif; ?>><?php echo e(ucfirst($item)); ?></option>
                      <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </select>
                  </div>
                  <div class="col-md-4">
                    <div class="border rounded-4 px-3 py-2 h-100 d-flex align-items-center">
                      <div class="form-check mb-0">
                        <input class="form-check-input" type="checkbox" name="is_active" value="1" id="rule-active-<?php echo e($rule->id); ?>" <?php echo e($rule->is_active ? 'checked' : ''); ?>>
                        <label class="form-check-label fw-semibold" for="rule-active-<?php echo e($rule->id); ?>">
                          <?php echo e($rule->is_active ? 'Active now' : 'Keep disabled'); ?>
        ...
        <div class="card-footer border-0 pt-0">
          <?php echo e($rules->withQueryString()->links()); ?>
...
<?php echo $__env->make('layouts.admin-tailadmin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/amanagarwal/Desktop/gd_remake/gd_live_backend/resources/views/admin/moderation/rules.blade.php ENDPATH**/ ?>